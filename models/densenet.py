...
def _load_state_dict(model: nn.Module, model_url: str, progress: bool, in_channels: int) -> None:
    ...
    if in_channels != 3: # update the weight #duplicate the weight of the conv0 
